	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-blue-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 pb-24">
			...
			<main className="max-w-4xl mx-auto px-6 py-8">
				...
				{/* Schedule Summary */}
				<div
					className="bg-white/70 dark:bg-gray-800/50 backdrop-blur-md border border-white/20 dark:border-gray-700/50 rounded-2xl p-6 mb-6 animate-slide-up"
				...
				<div
					...
					<div className="flex gap-3">
						<input
							...
							className="flex-1 p-4 bg-white/50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
						/>
						<button
							onClick={handleApplyPromo}
							className="bg-blue-500 text-white px-6 rounded-xl hover:bg-blue-600 transition-colors font-semibold">
							Apply
						</button>
					</div>
					{order.promoCode && (
